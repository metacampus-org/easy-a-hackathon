...
By default the template creates a single `HelloWorld` contract under smart_contract folder in the `smart_contracts` directory. To add a new contract:
